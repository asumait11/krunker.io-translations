...
menu.btn.mods تعديلات
menu.btn.settings الإعدادات
menu.btn.customize تخصيص
menu.btn.invite دعوة
menu.btn.invite.clicked تم النسخ
menu.btn.join انضم
menu.btn.host انشئ لعبة
menu.btn.browser الخوادم
generic.wait ...يرجى الانتظار
